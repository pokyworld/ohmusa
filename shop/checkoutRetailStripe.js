class CardType {
  constructor(name, prefix, length) {
    this.name = name;
    this.prefix = prefix;
    this.length = length;
  }
...
const cards = {
  MasterCard: new CardType("MasterCard", "51,52,53,54,55", "16"),
  VisaCard: new CardType("VisaCard", "4", "13,16"),
  AmExCard: new CardType("DinersClubCard", "30,36,38", "14"),
  DinersClubCard: new CardType("DiscoverCard", "6011", "16"),
  enRouteCard: new CardType("JCBCard", "3088,3096,3112,3158,3337,3528", "16"),
  JCBCard: null,
  LuhnCheckSum: null
}
