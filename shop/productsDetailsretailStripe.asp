...
<!--END display NK images here
   ...
   <%end if%>
    ...
    <div align="center"><input class="orderButton"  type="submit" name="addtocart" border="0" value="OrderNOw" align="center"></div>
...
<stripe-buy-button
  buy-button-id="buy_btn_1N5Bd7AefTrv2Fbj4tMl4fz4"
  publishable-key="pk_live_51N4RDzAefTrv2Fbj4AyPSjzEaklPrXdC2J6SuuRTpKn5TrnYyscrj9Sq43h1MWvUzP5k4bMBFuk2K3xztuThqw2D00FQAFCFQh"
>
</stripe-buy-button>
...
<%end if	
	...
	<tr>
		...
		<td width="%"  >Your Name</td><td width="50%" > <input type="text" name="FullName" > <font style="color:#FF0000" size = "4"> *</font></td><td width="20%"></td></tr>
	
	<tr>		<td>Your Email</td><td> <input name="Email" type = "text"> <font style="color:#FF0000" size = "4"> *</font> </td><td></td></tr>
	
		
	<tr><td> One Line Title</td><td> <input name="Title" type = "text" > <font style="color:#FF0000" size = "4"> *</font> </td><td></td></tr>
...
<br>
   ...
   <div align="center">To become a dealer, please <a href="registration.asp"> Register Here</a></div>
