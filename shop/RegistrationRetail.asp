...
If len(strcontact)>0 Then
  ...
  '---------------------------------------------------------------------------------------------------
  'if no email in the system then ok to go forward to send an email to confirmed email
 ...
 cusType="Consumer"
  ...
  strMailContent2 = strMailContent2  & "https://omhusa.com/consumers/verifyEmail.asp?login=" & strlogin 
...
cnn.Close
  Set cnn = Nothing
    ...
    Response.Redirect "confirmregistrationRetail.asp"
  else
  ...
  strMailContent2 = strMailContent2  & "https://omhusa.com/consumers/passwordReset.asp?login=" & strlogin 
...
cnn.Close
  ...
  Response.Redirect "confirmregistrationRetail.asp?error=1"
...
<table class="mainTable">
  <tr>
	...
	<td width="10%" >
                                      ...
                                      <form method="POST" name="dealer" action="registrationRetail.asp"> 
                                             ...
                                             <br>
                                              ...
                                              <p  class="MsoBodyText" style="line-height: 200%; margin-top:-1; margin-bottom:-1">
                                              
                                              <br>
                                              
                                          Name<input type="text" name="pname" size="41" style="line-height: 200%;">*
                                             <br><br>
											 
                                              Email<input type="text" name="pemail" size="41" style="line-height: 200%;" >*</p>
											...
											Upon checking this box, you agree to our  <a href ="faqRetail.asp" target= "blank"> terms and conditions. </a> <br>											
                                              ...
                                              <p  style="margin-top: -1; margin-bottom: -1">
                                                                                                    I 
                                            agree<span style="line-height:150%">*<input type="checkbox" name="C11" value="1"></span></p><br>
