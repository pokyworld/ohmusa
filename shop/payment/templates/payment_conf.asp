...
<%
  ...
  <!-- RW("StripeCustomerId: " & StripeCustomerId) -->
  Stripe = Trim(Request.QueryString("stripe")&"")
  AdminAuth = Trim(Request.Querystring("auth")&"")
  If Stripe <> StripeCustomerId And Len(AdminAuth) = 0 Then : Response.End
